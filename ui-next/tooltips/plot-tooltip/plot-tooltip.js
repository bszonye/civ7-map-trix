...
const PlotTooltip = ComponentRegistry.register({
  ...
  images: [
    ...
    "blp:action_excavateartifacts",
    "blp:action_movebyrail",
    "blp:action_movebyroad",
    "blp:base_ticket-bg",
    "blp:base_ticket-gold_bg",
    "blp:base_ticket-negative_bg",
    ...
    "blp:hud_civics-icon_frame",
    "blp:hud_frontbanner",
    "blp:hud_frontbanner_overlay",
    "blp:hud_frontbanner_shadow",
    "blp:hud_turn-timer",
    ...
    "blp:victory_cultural",
    "blp:victory_diplomatic",
    "blp:victory_economic",
    "blp:victory_expansionist",
    "blp:victory_militaristic",
    "blp:victory_scientific",
  ],
  // TRIX: extend styling
